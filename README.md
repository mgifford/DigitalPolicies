...
ODP provides openly licensed, community-maintained model policy language that anyone can adopt, adapt, and improve.
...
| Domain | Status |
|---|---|
| [Data Centers & Environmental Sustainability](policies/data-centers/full-model.md) | Draft |
...
| [Web Sustainability](policies/web-sustainability/README.md) | Framework overview only |
...
- **Add a real-world example** — open a Pull Request with a jurisdiction that has enacted similar language
- **Improve model language** — open an Issue describing the problem, then a PR with proposed changes and rationale
- **Translate** — see the `/translations` directory (coming soon)
