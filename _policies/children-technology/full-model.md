...
- [x] Municipal / local government (educational technology, public digital services)
- [x] Regional / state / provincial government
- [x] National government
- [x] Public sector procurement
- [x] Regulated platforms and digital services accessible to children (private sector)
- [ ] Other: ___________
...
**1. Children's Best Interests as the Primary Consideration**
Article 3 of the UNCRC requires that the best interests of the child be the primary consideration in all actions affecting children. This applies to digital platform design, data practices, algorithmic systems, and content governance. "Best interests" means what is genuinely good for children's development, wellbeing, and rights — not what maximises their engagement time, which is the commercial interest of platforms.

**2. Children Are Rights-Holders, Not Products**
...
**3. Design Must Not Exploit Developmental Vulnerabilities**
...
**4. Data Collected From Children Requires Heightened Justification**
...
**6. Young People Must Have Agency**
Children — particularly adolescents — have rights to participate in decisions that affect them (UNCRC Article 12). Digital policy for children should not be made entirely by adults about children. Young people should be involved in the design of protections, the development of policy, and the oversight of platforms that serve them.

**7. Inclusion and Access Must Not Be Sacrificed**
...
> **Standard 1: Prohibited Practices in Services Accessible to Children**
> The following practices are prohibited in digital services that are likely to be accessed by children, regardless of whether those services are formally directed at children:
>
...
*Reference: [UK Children's Code (ICO)](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/childrens-information/childrens-code-guidance-and-resources/age-appropriate-design-a-code-of-practice-for-online-services/); [California AADC](https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202120220AB2273); [EU DSA Article 28](https://digital-strategy.ec.europa.eu/en/policies/digital-services-act-package); [COPPA Rule 2024](https://www.ftc.gov/legal-library/browse/rules/childrens-online-privacy-protection-rule-coppa)*

---

> **Standard 2: Age Assurance Without Surveillance**
> Where digital services are restricted to adults or require differentiated protections based on age, age assurance mechanisms must:
>
...
> **Standard 3: Data Minimisation and Deletion for Children's Data**
> Digital services that collect data from or about children shall:
>
...
> **Standard 4: Educational Technology Procurement**
> Public bodies procuring educational technology — including learning management systems, assessment tools, communication platforms, and classroom devices — shall require:
>
...
*Reference: [HRW: "How Dare They Peep into My Private Life" (2022)](https://www.hrw.org/report/2022/05/25/how-dare-they-peep-my-private-life/childrens-rights-violations-governments); [SOPIPA (California)](https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=201320140SB1177)*

---

> **Standard 5: Algorithmic Systems in Children's Services**
> Any algorithmic recommendation or content curation system used in a service primarily serving users under 18 shall:
>
...
> **Aspirational Standard 1: Children's Digital Rights Commissioner**
> Jurisdictions should consider establishing a Children's Digital Rights Commissioner — an independent office with authority to investigate platform practices, commission research, and issue guidance on children's digital rights. Ireland's proposed Digital Safety Commissioner and Australia's eSafety Commissioner provide reference models.

> **Aspirational Standard 2: Youth Advisory Boards for Platform Governance**
> Platforms serving children should establish youth advisory boards with actual decision-making power over design choices affecting young users — not merely consultation. Young people should have a genuine role in platform governance, not just product testing.
...
> **Children's Digital Rights Authority**
> The designated regulatory body shall have: a Children's Technology team with expertise in child development, digital design, and data systems; authority to conduct unannounced audits of platform design and algorithmic systems; power to order algorithmic changes and design modifications; and a dedicated child-friendly complaints mechanism. The body shall publish an annual Children's Digital Rights report.
...
> This policy shall be reviewed every two years given the pace of platform evolution. Reviews must include: direct consultation with young people; assessment of evidence on harms and benefits; evaluation of whether prohibited practices are adequately defined; and assessment of enforcement effectiveness.
